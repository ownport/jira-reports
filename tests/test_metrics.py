...
def test_dt_round_value():
    ...
    assert (
        ...
        '2016-01-06 07:06:23', '2016-01-06 07:00:00',
        '2016-01-06 07:00:00', '2016-01-06 00:00:00',
    )
    DATETIME = 1458832665
    assert (
        metrics.dt(DATETIME), metrics.dt_round(DATETIME, 900),
        ...
        '2016-03-24 15:17:45', '2016-03-24 15:15:00',
        '2016-03-24 15:00:00', '2016-03-24 00:00:00',
    )
